...
namespace CHub
{
    public partial class OptionsDefault : ClassLibrary.Page
    {
        /// <summary>
        /// 载入窗口
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SearchGridList1.FieldSQL = "SELECT MLFB, OptionValue FROM View_Info_Options WHERE 1=0";
            SearchGridList1.GridFieldKeyName = "ID";
            SearchGridList1.IsShowSelect = true;

            SearchGridList1.SQL = "select  ID, MLFB, OptionValue, CurrentPrice, Type, [Create Date], [Create User] from View_Info_Options where 1=1";
        ...
        {
            Response.Redirect("OptionsOperation.aspx?Type=addnew");
        }
        protected void SearchGridList1_btnModifyClick(object o, EventArgs e)
        {
            ...
            {
                Response.Redirect("OptionsOperation.aspx?ID=" + strID + "&Type=modify");
            }
        }
        protected void SearchGridList1_btnDeleteClick(object o, EventArgs e)
        {
            ...
            {
                string strSQL = "";
                strSQL = "select MLFB, OptionValue from CHub_Info_LP where ID = '" + strID + "'";
                DataSet ds = new DataSet();
                ds = objClassDbAccess.funDataset_SQLExecuteNonQuery(strSQL);
                if (ds.Tables[0].Rows.Count > 0)
                {
                    strSQL = "DELETE CHub_Info_LP where MLFB='" + ds.Tables[0].Rows[0]["MLFB"].ToString() + "' AND PriceType='Options' AND OptionValue='" + ds.Tables[0].Rows[0]["OptionValue"].ToString() + "'";
        ...
        protected void SearchGridList1_btnDetailClick(object o, EventArgs e)
        {
            ...
            if (strID.ToString().Trim() != "")
            {
                Response.Redirect("OptionsDetail.aspx?ID=" + strID + "");
            }
        }
        ...
        {
            Response.Redirect("OptionsImport.aspx");
        }
        #endregion
    }
}
