...
namespace CHub
{
    public partial class DriveOptionsDetail : ClassLibrary.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                #endregion
                ((CHub.Main)Master).TitleName = "DriveOptionsDetail";
        ...
        {
            string strSQL = "SELECT  MLFB, OptionValue, CurrentPrice, IsDiscount, Type FROM ViewDrive_Info_Options where ID=" + OptionsID;
        ...
        {
            Response.Redirect("DriveOptionsOperation.aspx?ID=" + ViewState["OptionsID"].ToString() + "&Type=modify");
        }
    }
}
