<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OptionsImport.aspx.cs" Inherits="CHub.OptionsImport" 
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="2" id="tblUpLoad" runat="server">
        <tr>
            <td colspan="2" style="padding-bottom:14px; font-size:12px; line-height:20px; text-align:right;">
                (Template:<a href="Document/Excel/Options.xlsx" class="active" target="_blank">click download template</a>)
            </td>
        </tr>
        <tr>
