<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyInformation.aspx.cs"
    Inherits="CHub.MyInformation" MasterPageFile="~/Main.Master" %>
                ...
                <table cellpadding="0" cellspacing="1" border="0" width="100%" style="background-color: #CCCCCC;">
                    <tr style="background-color: #FFFFFF;">
                        ...
                        <td style="padding: 4px;">
                            <input id="txtLoginName" type="text" runat="server" maxlength="30" class="idio_TextAreaDisabledStyleNoWH"
                                readonly="readonly" />
